...
class TestQuantEngine(unittest.TestCase):
    ...
    def test_lambda_derivation(self):
        ...
        """
        lambda_val = get_consensus_lambda([{'book': 'Pinnacle', 'odds': {'Under2.5': 1.952, 'Over2.5': 1.934}}]) 
        
        self.assertAlmostEqual(lambda_val, 2.68, places=2, 
    ...
    def test_ev_calculation(self):
        ...
        self.assertAlmostEqual(ev, 0.25, places=3, 
            msg=f"EV Math is broken! Expected 0.25, got {ev}")
    ...
    def test_negative_ev_calculation(self):
        ...
        self.assertAlmostEqual(ev, -0.10, places=3, 
            msg="Negative EV not properly handled!")
    ...
    def test_kelly_stake_sizing(self):
        ...
        self.assertAlmostEqual(stake, 1.66, places=1, 
            msg=f"Stake sizing is reckless! Expected ~1.66, got {stake}")
    ...
    def test_htft_lambda_split(self):
        ...
        self.assertAlmostEqual(expected_ht_home_lambda, 0.7155, places=4,
